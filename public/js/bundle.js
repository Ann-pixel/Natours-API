...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"updateData.js":[function(require,module,exports) {
"use strict";
...
function displayMap(tourLocations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZ2F1cmltaGFpc2thciIsImEiOiJja25xZ3EweWowZDZpMnZteTUwbHJ5YTF0In0.dLc4_FiWhvy62qXdnBXFRA";
  ...
  tourLocations.forEach(function (loc) {
...
var stripe = Stripe("pk_test_51IkKn5EM32bMERIhp60RpWAQU0ViAduFvfeqHvyNOhc71o109biHleVdoR1sBersvPJWJjLXryg7Aj1PlKE7oJVL00lxci70nN");
...
if (mapBox) {
  var tourLocations = JSON.parse(document.getElementById("map").dataset.locations);
...
if (loginForm) {
  document.querySelector(".form").addEventListener("submit", function (evt) {
    ...
    console.log("from index.js ".concat(password, ", ").concat(email));
